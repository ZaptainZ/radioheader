...
**Register new project**: After enabling the framework, also register the project in `__HOME__/.claude/radioheader/project-registry.json` (and keep `project-registry.md` in sync via consolidate).
